<template>
    <div class="m-t-20">
        ...
        <div v-if="showVideoPopup" class="po-fixed po-fixed-mod bg-c-popup flex justify-center items-center">
            <div class="div">
                <video :src="curruntVideo.videoUrl" controls></video>
                <div @click="showVideoPopup = false">
