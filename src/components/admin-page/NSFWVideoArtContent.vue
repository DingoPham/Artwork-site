    ...
    export default{
        ...
        methods:{
            ...
            saveVideo(){
                ...
                if (this.editMode){
                    fetch(`https://artwork-core-for-render-build.onrender.com/NSFWVideo/put/${this.videos[this.editIndex].id}`,{ 
                        method: 'PUT',
                        headers: headers,
                    ...
                    fetch('https://artwork-core-for-render-build.onrender.com/NSFWVideo/post',{
                        method: 'POST',
                        headers: headers,
                        body: JSON.stringify({Type: type, Data: videoData})
                    })
