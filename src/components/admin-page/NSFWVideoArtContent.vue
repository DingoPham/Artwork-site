...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            fetchVideos(){
                fetch('http://dingo.bigcat.id.vn/NSFWVideo', {
                    headers: {
            ...
            saveVideo(){
                ...
                if (this.editMode){
                    fetch(`http://dingo.bigcat.id.vn/NSFWVideo/put/${this.videos[this.editIndex].id}`,{ 
                        method: 'PUT',
                        headers: headers,
                    ...
                    fetch('http://dingo.bigcat.id.vn/NSFWVideo/post',{
                        method: 'POST',
                        headers: headers,
                        body: JSON.stringify({Type: type, Data: videoData})
                    })
            ...
            deleteVideo(id){
                ...
                fetch('http://dingo.bigcat.id.vn/NSFWVideo/del/', {
                    method: 'DELETE',
                    headers: headers,
